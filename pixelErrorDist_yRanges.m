%% Plot distribution curve for each Y distance range (in pixel).
%
...
% Changes made to Ben's program:
%   - Add a table for better showing
%   - Add mu, sigma for errors on X direction
...
%% Pre-calculated values, don't forget it starts from 1
...
t_dist = table(Range,PixelRangeStart,PixelRangeEnd,n_objects,mu_y,...
				sigma_y,z_score_y, mu_x,sigma_x,z_score_x);
...
title('Fitted probability distribution functions');
